	...
	<body>
		...
		<?php
			...
			if(isset($_POST['search'])){
				...
				$sq = " select * from photographer where address like '%$searchKey%' ";
			}
			else{
				$sq = " select * from photographer ";
				$searchKey = "";
			}
			$query = mysqli_query($con, $sq);
			$total = "select count(id) as ttl from photographer";
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				<div class="d-flex justify-content-center">
					<h1 class="txt text-center " style="font-size: 1.5vw;">Photographers' list</h1>
				</div>
				...
				<tr class="bg-danger text-white text-center">
					...
					<th  style="font-size: 2vw;">Name</th>
				...
				<tr class="text-center">
					...
					<td style="font-size: 2vw;"><a href="Profile_Photography.php?id=<?php echo $res['id']; ?>"><button class="btn btn-success">Profile</button></a></td>
