		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				<div class="d-flex justify-content-center">
					<h1 class="txt text-center " style="font-size: 1.5vw;">Seminar Venues</h1>
				</div>
				...
				<tr class="bg-danger text-white text-center">
					...
					<th  style="font-size: 2vw;">Venue</th>
				...
				<tr class="text-center">
					...
					<td style="font-size: 2vw;"><a href="Profile_Seminar.php?id=<?php echo $res['id']; ?>"><button class="btn btn-success">visit</button></a></td>
				</tr>
				<?php
			}
