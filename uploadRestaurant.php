...
if(isset($_POST['submit'])){
	header('location:ReqAs_Restaurant.php');
	$name = $_POST['name'];
	$email = $_POST['email'];
	$mobile = $_POST['mobile'];
	...
	if($fileerror == 0 && $fileerror1 == 0 && $fileerror2 == 0 && $fileerror3 == 0 && $fileerror4 == 0 && $fileerror5 == 0 && $fileerror6 == 0 && $fileerror7 == 0 && $fileerror8 == 0){
		...
		$insertquery = " INSERT INTO `restaurants`(`name`, `email`, `mobile`, `address`, `availibility`, `capacity`, `offers`, `pp`, `pp1`, `pp2`, `pp3`, `pp4`, `pp5`, `pp6`, `pp7`, `pp8`) VALUES('$name', '$email', '$mobile', '$address', '$availibility', '$capacity', '$offers', '$destfile', '$destfile1', '$destfile2', '$destfile3', '$destfile4', '$destfile5', '$destfile6', '$destfile7', '$destfile8')";
